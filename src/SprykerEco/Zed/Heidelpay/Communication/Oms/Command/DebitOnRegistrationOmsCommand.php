...
class DebitOnRegistrationOmsCommand extends BaseOmsCommand implements HeidelpayOmsCommandByOrderInterface
{
    /**
    ...
    public function execute(array $salesOrderItems, SpySalesOrder $salesOrderEntity, ReadOnlyArrayObject $data): void
    {
        ...
        $this->heidelpayFacade->executeDebitOnRegistration($orderTransfer);
    }
}
