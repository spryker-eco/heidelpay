 ...
 */
class IsFinalizingFinishedPlugin extends AbstractPlugin implements ConditionInterface
{
    /**
     * {@inheritDoc}
     * - Checks if Finalize notification received with success code for given order item.
     *
     * @api
     *
    ...
    public function check(SpySalesOrderItem $orderItem): bool
    {
        return $this->getFactory()
            ->createIsFinalizingFinishedOmsCondition()
            ->check($orderItem);
    }
}
